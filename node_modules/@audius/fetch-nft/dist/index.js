...
var assetToCollectible = function (asset) { return __awaiter(void 0, void 0, void 0, function () {
    var mediaType, frameUrl, imageUrl, videoUrl, threeDUrl, gifUrl, animation_url, animation_original_url, imageUrls, res, hasGifFrame, res, isVideo, isGif, res, isGif, isVideo, e_1;
    ...
    return __generator(this, function (_o) {
        switch (_o.label) {
            ...
            case 4:
                ...
                frameUrl =
                    (_b = imageUrls.find(function (url) {
                        return url && NON_IMAGE_EXTENSIONS.every(function (ext) { return !url.endsWith(ext); });
            ...
            case 5:
                ...
                _o.label = 6;
            case 6:
                videoUrl = __spreadArray([animation_url, animation_original_url], imageUrls, true).find(function (url) {
                    return url && SUPPORTED_VIDEO_EXTENSIONS.some(function (ext) { return url.endsWith(ext); });
                });
                return [3 /*break*/, 9];
            case 7:
                mediaType = 'IMAGE';
            ...
            case 8:
                res = _o.sent();
                isGif = (_e = res.headers.get('Content-Type')) === null || _e === void 0 ? void 0 : _e.includes('gif');
                isVideo = (_f = res.headers.get('Content-Type')) === null || _f === void 0 ? void 0 : _f.includes('video');
                if (isGif) {
                    mediaType = 'GIF';
                    gifUrl = frameUrl;
                    // frame url for the gif is computed later in the collectibles page
            ...
            case 11: return [2 /*return*/, {
                    id: asset.token_id + ":::" + ((_h = (_g = asset.asset_contract) === null || _g === void 0 ? void 0 : _g.address) !== null && _h !== void 0 ? _h : ''),
                    tokenId: asset.token_id,
                    name: (_k = (asset.name || ((_j = asset === null || asset === void 0 ? void 0 : asset.asset_contract) === null || _j === void 0 ? void 0 : _j.name))) !== null && _k !== void 0 ? _k : '',
                    ...
                    assetContractAddress: (_m = (_l = asset.asset_contract) === null || _l === void 0 ? void 0 : _l.address) !== null && _m !== void 0 ? _m : null,
                    chain: 'eth',
                    wallet: asset.wallet
                }];
        }
...
var OpenSeaClient = /** @class */ (function () {
    function OpenSeaClient(props) {
        ...
        this.getTransferredCollectiblesForWallet = function (wallet, limit) {
            if (limit === void 0) { limit = _this.eventLimit; }
            return __awaiter(_this, void 0, void 0, function () {
                var url, res, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = this.url + "/events?account_address=" + wallet + "&limit=" + limit + "&event_type=transfer&only_opensea=false";
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, fetch(url, this.requestOptions).then(function (r) { return r.json(); })];
                        case 2:
                            res = _a.sent();
                            return [2 /*return*/, res];
                        case 3:
                            e_1 = _a.sent();
                            console.error(e_1, url);
                            throw e_1;
        ...
        this.getTransferredCollectiblesForMultipleWallets = function (wallets, limit) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, Promise.allSettled(wallets.map(function (wallet) {
                            return _this.getTransferredCollectiblesForWallet(wallet, limit);
                        })).then(function (results) { return parseAssetEventResults(results, wallets); })];
                });
            });
        };
        this.getCreatedCollectiblesForWallet = function (wallet, limit) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = this.url + "/events?account_address=" + wallet + "&limit=" + limit + "&event_type=created&only_opensea=false";
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, fetch(url, this.requestOptions).then(function (r) { return r.json(); })];
        ...
        this.getCollectiblesForWallet = function (wallet, limit) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = this.url + "/assets?owner=" + wallet + "&limit=" + limit;
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, fetch(url, this.requestOptions).then(function (r) { return r.json(); })];
        ...
        this.eventLimit = (_d = props === null || props === void 0 ? void 0 : props.eventLimit) !== null && _d !== void 0 ? _d : this.eventLimit;
        if (this.apiKey) {
            this.requestOptions = {
...
var nftImage = function (nft) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_f) {
        ...
        isImage = ((_c = nft.properties) === null || _c === void 0 ? void 0 : _c.category) === 'image' || ((_d = nft.image) === null || _d === void 0 ? void 0 : _d.length) || imageFile;
        if (isImage) {
            url = void 0;
            if ((_e = nft.image) === null || _e === void 0 ? void 0 : _e.length) {
                url = nft.image;
            }
            else if (imageFile) {
                url = imageFile.uri;
...
var starAtlasNFTToCollectible = function (nft) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_g) {
        ...
        is3DObj = [nft.image, (_a = nft.media) === null || _a === void 0 ? void 0 : _a.thumbnailUrl]
            .filter(Boolean)
            .some(function (item) {
            return ['glb', 'gltf'].some(function (extension) { return item.endsWith(extension); });
        });
        hasImageFrame = [nft.image, (_b = nft.media) === null || _b === void 0 ? void 0 : _b.thumbnailUrl]
            .filter(Boolean)
            .some(function (item) {
            return ['glb', 'gltf'].every(function (extension) { return !item.endsWith(extension); });
        });
...
var METADATA_PROGRAM_ID_PUBLIC_KEY = new web3_js.PublicKey('metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s');
var SolanaClient = /** @class */ (function () {
    function SolanaClient(props) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(wallets.map(function (address) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    return [2 /*return*/, connection_1.getParsedTokenAccountsByOwner(new web3_js.PublicKey(address), {
                                    ...
                                    return __generator(this, function (_c) {
                                        switch (_c.label) {
                                                    ...
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0: return [4 /*yield*/, web3_js.PublicKey.findProgramAddress([
                                                                    ...
                                                                    new web3_js.PublicKey(mintAddress).toBytes()
                                            ...
                                            case 3:
                                                ...
                                                return [2 /*return*/, metadatas.filter(function (r) { return !!r.metadata && Object.keys(r.metadata).length > 0; })];
                                        }
                                    });
                                });
                            }))];
        ...
        this._metaplexMints = function (text) {
            ...
            var defaultRegex = /https:\/\/(.*)\.(.*)\/api\/metaplex-mints\/[A-Za-z0-9_]{44}/gm;
            // e.g. https://bitboat.me/api/metaplex-mints/boat/4uAV88PuEAM56X4S2zcEom1omKULmdA4mj5kMqtz6xwb
            var complexRegex = /https:\/\/(.*)\.(.*)\/api\/metaplex-mints\/(.*)\/[A-Za-z0-9_]{44}/gm;
            var defaultResult = (text.match(defaultRegex) || text.match(complexRegex) || []).join('');
...
var FetchNFTClient = /** @class */ (function () {
    function FetchNFTClient(props) {
        var _this = this;
        var _a, _b;
        this.getEthereumCollectibles = function (wallets) { return __awaiter(_this, void 0, void 0, function () { var _a; return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
        ...
        this.getSolanaCollectibles = function (wallets) { return __awaiter(_this, void 0, void 0, function () { var _a; return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!wallets.length) return [3 /*break*/, 2];
